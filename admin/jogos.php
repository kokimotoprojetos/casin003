                                ...
                                <form method="GET" action="" class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <select name="filter_api" class="form-select" onchange="this.form.submit()">
                                            ...
                                            <option value="iGameWin" <?= $filter_api == 'iGameWin' ? 'selected' : '' ?>>MaxAPI</option>
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <?php
                                                    $apiRaw = (string)$game['api'];
                                                    $apiLower = strtolower($apiRaw);
                                                    $apiLabel = $apiRaw;
                                                    if ($apiLower === 'igamewin') {
                                                        $apiLabel = 'MaxAPI';
                                                    }
                                                    $apiColor = 'info';
                                                    if ($apiLower === 'pgclone') $apiColor = 'primary';
                                                    elseif ($apiLower === 'igamewin') $apiColor = 'success';
                                                    elseif ($apiLower === 'drakon') $apiColor = 'warning';
                                                    elseif ($apiLower === 'playfiver') $apiColor = 'danger';
                                                ?>
                                                <td>
                                                    <span class="badge bg-<?= $apiColor ?>">
                                                        <?= htmlspecialchars($apiLabel) ?>
                                                    </span>
                                                </td>
                                                <td>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select name="api" class="form-select" required>
                                                                        ...
                                                                        <option value="iGameWin" <?= strcasecmp($game['api'], 'iGameWin') === 0 ? 'selected' : '' ?>>MaxAPI</option>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="api" class="form-select" required>
                                ...
                                <option value="iGameWin">MaxAPI</option>
