...
<head>
    <?php $title = admin_t('page_checkin_title');
                    ...
                    <div class="col-lg-12">
                        <div class="card rounded-4 shadow-sm">
                            <div class="card-header bg-transparent border-bottom-0 pt-4 px-4">
                                <h4 class="card-title fw-bold mb-0"><?= admin_t('checkin_card_title') ?></h4>
                                <p class="text-muted fs-13 mb-0"><?= admin_t('checkin_card_subtitle') ?></p>
                            </div>
                            ...
                            <div class="card-body p-4">
                                <form method="POST" action="">
                                            ...
                                            <div class="card bg-light border-0">
                                                <div class="card-body">
                                                    <div class="form-check form-switch mb-3">
                                                        ...
                                                        <label class="form-check-label fw-bold" for="dep_on"><?= admin_t('checkin_dep_toggle_label') ?></label>
                                                    </div>
                                                    <div class="mb-0">
                                                        <label class="form-label"><?= admin_t('checkin_dep_value_label') ?></label>
                                                        <input type="number" step="0.01" name="dep" class="form-control" value="<?= $config['dep'] ?>">
                                                        <div class="form-text text-muted fs-12"><?= admin_t('checkin_dep_helper') ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card bg-light border-0">
                                                <div class="card-body">
                                                    <div class="form-check form-switch mb-3">
                                                        ...
                                                        <label class="form-check-label fw-bold" for="aposta_on"><?= admin_t('checkin_bet_toggle_label') ?></label>
                                                    </div>
                                                    <div class="mb-0">
                                                        <label class="form-label"><?= admin_t('checkin_bet_value_label') ?></label>
                                                        <input type="number" step="0.01" name="aposta" class="form-control" value="<?= $config['aposta'] ?>">
                                                        <div class="form-text text-muted fs-12"><?= admin_t('checkin_bet_helper') ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <h5 class="fw-bold mb-3"><?= admin_t('checkin_rewards_title') ?></h5>
                                    <div class="row g-3">
                                        <?php for($i=1; $i<=7; $i++): ?>
                                        <div class="col-md-3">
                                            <label class="form-label"><?= admin_t('checkin_day_label') ?> <?= $i ?></label>
        ...
        function showToast(type, message) {
            ...
            toast.innerHTML = `
                <div class="toast-header">
                    <h5 class="me-auto my-0"><?= admin_t('notifications') ?></h5>
