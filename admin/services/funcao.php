...
if (php_sapi_name() != "cli") {
    ...
    $painel_adm_administradores = $painel_adm . 'administradores.php';
    $painel_adm_cupons = $painel_adm . 'ge-cupons.php';
    $painel_adm_cpa = $painel_adm . 'gerenciamento-afiliados.php';
    $painel_adm_slider_front = $painel_adm . 'editar-banners.php';
    $painel_adm_front_site = $painel_adm . 'configuracoes.php';
    $painel_adm_suit_pay = $painel_adm . 'gateway.php';
    $painel_adm_provedores_games = $painel_adm . 'api.php';
    $painel_adm_slots_games = $painel_adm . 'jogos.php';
    $painel_adm_financeiro_sistema = $painel_adm . 'configuracoes.php';
    $painel_adm_listar_usuarios = $painel_adm . 'usuarios.php';
    $painel_adm_exportar = $painel_adm . 'exportar.php';
    $painel_adm_ver_usuarios = $painel_adm . 'detalhes_usuario.php?slug=';
    $painel_adm_saldo_api_js = $painel_adm . 'saldo-api-js.php';
    $painel_adm_depositos_pendentes = $painel_adm . 'depositos_pendentes.php';
    $painel_adm_all_depositos = $painel_adm . 'depositos_pagos.php';
    $painel_adm_saques_pendentes = $painel_adm . 'saques_pendentes.php';
    $painel_adm_all_saques = $painel_adm . 'saques_aprovados.php';
    $painel_adm_view_game = $painel_adm . 'games.php?slug=';
