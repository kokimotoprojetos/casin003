...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['update_igamewin'])) {
        $data = [
            ...
            'agent_secret' => $_POST['agent_secret_igamewin'] ?? '',
            'ativo' => intval($_POST['ativo_igamewin']),
        ];

        if (update_igamewin_config($data)) {
            $toastType = 'success';
            $toastMessage = 'Credenciais do MaxAPIGames atualizadas com sucesso!';
        } else {
            $toastType = 'error';
            $toastMessage = 'Erro ao atualizar as credenciais do MaxAPIGames. Tente novamente.';
        }
    }
    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="container-xxl">
                ...
                <!-- MaxAPIGames Configuration (tabela legada `igamewin`) -->
                <div class="row justify-content-center mb-4">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Gerenciamento de Credenciais (MaxAPIGames)</h4>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card mb-4">
                                                <div class="card-body">
                                                    <h5 class="card-title">Agent Secret <small class="text-muted">(webhook seamless)</small></h5>
                                                    <div class="input-group">
                                                        <input type="password" id="agent_secret_igamewin" name="agent_secret_igamewin" class="form-control" value="<?= htmlspecialchars($igamewin_config['agent_secret'] ?? '') ?>">
                                                        <span class="input-group-text" onclick="togglePassword('agent_secret_igamewin', this)">
                                                            <i class="ti ti-eye"></i>
                                                        </span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-success">Salvar Configurações MaxAPIGames</button>
                                    </div>
                                </form>
                            </div>
                        </div>
